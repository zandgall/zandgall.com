<html lang="en">
    ...
    <title>Zandgall - Flowfield</title>
    <meta name="description" content="A flowfield">
    ...
    <div id = "cut" style="height: 100vh; width: 100%; top: 0; left: 0; overflow: hidden;">
        <div id="universal" class = "parallax">
            ...
            <div style="margin:auto; width: 766; height: 60"> 
                <canvas class="section" id="Perlin" width=766 height=766 style="position:relative; margin: auto; margin-top:100; margin-bottom: 100; width:766; height:766">CANVAS NOT SUPPORTED</canvas>
            </div>
         
            <script type="text/javascript" src="Funsies/NOISE/flowfield.js">
            </script>
        </div>
    </div>
