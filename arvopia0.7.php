...
<html lang="en">
    ...
    <title>Zandgall - Arvopia 0.7</title>
    <meta name="description" content="Information about Arvopia 0.7, Customization update">
    ...
    <div id = "cut" style="height: 100vh; width: 100%; top: 0; left: 0; overflow: hidden;">
        <div id="universal" class = "parallax">
            ...
            <div class="section" style="position: relative; margin-left: auto; margin-right: auto; margin-top: 80; width: 800">
                ...
                <!--STUFF HERE-->
               <img class="section"src="assets/arvopia/arvopia0.7.png" style="width:98%; position: relative; left:0.8%; margin-top:5">
                <h1 class="basictext">
                    Version 0.7
                </h1>
                ...
                <img class="section" src="assets/arvopia/arvopia 0.7/mods.png" style="width: 98%; position: relative; left:0.8%; margin-top: 5; margin-bottom: 5">
                <div class = "splitter"></div>
                ...
                <img class="section" src="assets/arvopia/arvopia 0.7/Player Customization.png" style="width:98%; position: relative; left: 0.8%; margin-top: 5; margin-bottom: 5">
                ...
                <img class="section" src="assets/arvopia/arvopia 0.7/levelcreator.png" style="width:98%; position:relative; left: 0.8%; margin-top: 5; margin-bottom: 5;">
                ...
                <img class="section" src="assets/arvopia/arvopia 0.7/TradeMenu.png" style="width:98%; position:relative; left: 0.8%; margin-top: 5; margin-bottom: 20;">

                <a href="Downloads/Arvopia0.7.zip"><div class="section" style="width:75%; margin-left: auto; margin-right: auto; margin-bottom: 20;"><h1 class="basictext outlinetext">Download Arvopia 0.7.zip</h1></div></a>
                <div class="splitter" style="margin-bottom:10;"></div>
                <a href="arvopia0.6" style="position:relative; float:left; margin-bottom: 10;"><div style="margin-left: 10;"><h3 class="basictext">Previous Version: 0.6</h3></div></a>
                <a href="arvopia" style="position:absolute; align-content: center; text-align: center; float: left; left: 50%; margin-left: auto; margin-right: auto; margin-bottom: 10;"><div style="margin-left: -50%;"><h3 class="basictext">Back</h3></div></a>
                <a href="arvopia0.8" style="position:relative; float:right; margin-bottom: 10;"><div style="margin-right: 10;"><h3 class="basictext">Next Version: 0.8</h3></div></a>
