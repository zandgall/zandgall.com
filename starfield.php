<html lang="en">
    ...
    <title>Zandgall - Starfield</title>
    <meta name="description" content="Starfield, predecessor to Solar Glyphs">
...
<body>
    ...
    <div id = "cut" style="height: 100vh; width: 100%; top: 0; left: 0; overflow: hidden;">
        <div id="universal" class = "parallax">
            ...
            <div style="margin:auto; width:766">
            ...
            <script type="text/javascript" src="Funsies/Starfield/starfield.js">
