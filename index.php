...
<div id="projectss" style="position: relative; width:60vw; max-width:900px; height:2850px; margin:auto">
        <?php
        project("100%", "500px", "Plorpland", "An adventure game", "assets/thumbnail/Plorpland.png", "https://zandgall.itch.io/plorpland");
        ...
        project(
                ...
                "A simple pure-js 3D rasterization engine, with shaders and reflections and things.",
                "assets/thumbnail/Rasterizer.png",
                "/rasterizer"
        );
        project(
                "50%",
                "400px",
                "NBT Video Essay",
                "A 20 min video essay explaining the details of the NBT format, how to use it, and comparisons to other general format JSON.",
                "assets/thumbnail/NBT.png",
                "https://youtu.be/12PAtF2Ih_c"
        );
        project(
                "40%",
                "600px",
                "QB64 3D",
                "A essay sat here on this website explaining the intricacies of 3D graphics, starting from nothing.",
                "assets/thumbnail/QB64 3D.png",
                "/qb64%203d"
        );
        project(
                "60%",
                ...
                "assets/thumbnail/VectorField.png",
                "vectorfield"
        );
        project("60%", "200px", "Super Marbo", "An original title", "assets/thumbnail/Marbo.png", "marbo");
        project(
                "60%",
                "200px",
                "Schute!",
                "A game based on strategically planting \"Schutes\" that you can then climb and use to collect coins and beat levels",
                "assets/thumbnail/Schute.png",
                "schute"
        );
        project(
                "50%",
                "400px",
                "Arvopia",
                "My old longest standing project. It's a little misc platformer game with NPCs, crafting, and combat",
                "assets/thumbnail/Arvopia.png",
                "arvopia"
        );
        project(
                "50%",
                ...
                "A quick level making tool that was used before Arvopia had it's own levelCreator built in",
                "assets/thumbnail/LevelMaker.png",
                "arvopialevelcreator"
        );
        project(
                "50%",
                "200px",
                "Misc Arvopia Tools",
                "A couple different tools used for development in Arvopia. Animation, Menu designer, and Server testing included.",
                "assets/thumbnail/ArvopiaMisc.png",
                "arvopia/misctools"
        );
        project(
                "33.33%",
                "200px",
                "Normal Buddy",
                "A small little program that takes an image and makes a NormalMap out of it",
                "assets/thumbnail/NormalBuddy.png",
                "normalbuddy"
        );
        project(
                "33.33%",
        ...
        project(
                ...
                "200px",
                "Falling Mine",
                "A submission for the ScoreSpace GameJam. Composed of platforms that fall, and you having to jump to live",
                "assets/thumbnail/FallingMine.png",
                "fallingmine"
        );
        project(
                "50%",
        ...
        project(
                ...
                "assets/thumbnail/SolarGlyphs.png",
                "solarglyphs"
        );
        ?>
</div>
