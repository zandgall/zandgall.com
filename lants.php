...
<div class="section" style="position: relative; margin-left: auto; margin-right: auto; margin-top: 0; width: min(800px, 80vw); margin-bottom: 2cm">
    <!--STUFF HERE-->
    <img class="section" style="image-rendering: pixelated; margin-top: 2cm; margin-left: -5%; margin-bottom: 1cm; position: relative; width: 110%; height: auto;" src="assets/lants/0.png" alt="Lants Screenshot">
    ...
    <img class="section" style="image-rendering: pixelated; margin-top: 2cm; margin-left: -5%; margin-bottom: 1cm; position: relative; width: 110%; height: auto;" src="assets/lants/convolution.gif" alt="Lants convolution type">
    ...
    <img class="section" style="image-rendering: pixelated; margin-top: 2cm; margin-left: -5%; margin-bottom: 1cm; position: relative; width: 110%; height: auto;" src="assets/lants/the%20ant.gif" alt="The Ant">
    ...
    <img class="section" style="image-rendering: pixelated; margin-top: 2cm; margin-left: -5%; margin-bottom: 1cm; position: relative; width: 110%; height: auto;" src="assets/lants/chunks%20and%20highways.gif" alt="Chunks and Highways">
    ...
    <img class="section" style="image-rendering: pixelated; margin-top: 2cm; margin-left: -5%; margin-bottom: 1cm; position: relative; width: 110%; height: auto;" src="assets/lants/oscillator.gif" alt="Oscillator">
    ...
    <img class="section" style="image-rendering: pixelated; margin-top: 2cm; margin-left: -5%; margin-bottom: 1cm; position: relative; width: 110%; height: auto;" src="assets/lants/dual%20oscillator.gif" alt="Dual Oscillator">
    ...
    <img class="section" style="image-rendering: pixelated; margin-top: 2cm; margin-left: -5%; margin-bottom: 1cm; position: relative; width: 110%; height: auto;" src="assets/lants/growing%20diamond.gif" alt="Growing Diamond">
    <h2 class = "basictext">Putting two ants one on top of the other, will start forming this diamond shape,</h2>

    <img class="section" style="image-rendering: pixelated; margin-top: 2cm; margin-left: -5%; margin-bottom: 1cm; position: relative; width: 110%; height: auto;" src="assets/lants/eating.gif" alt="Eating">
    ...
    <img class="section" style="image-rendering: pixelated; margin-top: 2cm; margin-left: -5%; margin-bottom: 1cm; position: relative; width: 110%; height: auto;" src="assets/lants/building%20and%20eating.gif" alt="Building and Eating">
    <h2 class = "basictext">Another example of building and eating</h2>

    <a href="Downloads/Lants%20v1.0.0.zip"><div class="section" style="width:75%; margin-left: auto; margin-right: auto; margin-bottom: 2cm;"><h1 class="basictext outlinetext">Download Lants v1.0.0.zip</h1></div></a>
