...
<body>
    ...
    <section id='interface'>
        ...
        <form id='interfaceForm'>
            ...
            <input type="hidden" name="table" value="<?=$PAGE_PATH?>">
        </form>
    </section>
    ...
    <script>
        ...
        var POST_SCRIPT = "<?=$ROOT?>csc235/project/ajaxified/post";
    </script>

    <script src="<?php echo $ROOT;?>/csc235/project/ajaxified/script.js"></script>
</body>
</html>