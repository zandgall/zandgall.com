...
function mouseEnteredBackpack() {mouseOverBackpack = true;}
function mouseLeftBackpack() {mouseOverBackpack = false;}

// Add move triggers for all elements and slots
for(let i = 1; i<=8; i++) {
    if(document.getElementById("element"+i)!=null)
        moveElement(document.getElementById("element" + i));
    if(document.getElementById("slot"+i)!=null)
        moveElement(document.getElementById("slot" + i));
}
