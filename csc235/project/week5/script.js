...
function submitTransaction(e) {
    ...
    fetch("https://www.zandgall.com/csc235/project/week5/pagelet.php", {
        method:"POST",
        body: JSON.stringify({
            hidInterface: 0,
            lstSlot: document.getElementById("lstSlot").value,
            radType: document.querySelector('input[name="radType"]:checked').value
        }),
        headers: {
