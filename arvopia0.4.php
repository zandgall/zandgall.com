<html lang="en">
    ...
    <title>Zandgall - Arvopia 0.4</title>
    <meta name="description" content="Information about Arvopia 0.4, the Light Update">
    ...
    <div id = "cut" style="height: 100vh; width: 100%; top: 0; left: 0; overflow: hidden;">
        <div id="universal" class = "parallax">
            ...
            <div class="section" style="position: relative; margin-left: auto; margin-right: auto; margin-top: 80; width: 800">
                ...
                <!--STUFF HERE-->
                <img class="section"src="assets/arvopia/arvopia0.4.png" style="width:98%; position: relative; left:0.8%; margin-top:5">
                <h1 class="basictext">
                    Version 0.4
                </h1>
                ...
                <img class="section" src="assets/arvopia/arvopia 0.4/options.png" style="image-rendering: pixelated; width:98%; position: relative; left:0.8%">
                ...
                <div class="splitter" style="margin-bottom:10"></div>
                <img class="section" src="assets/arvopia/arvopia 0.4/lighting.png" style="width:98%; position: relative; left:0.8%">
                ...
                <a href="Downloads/Arvopia0.4.zip"><div class="section" style="width:75%; margin-left: auto; margin-right: auto; margin-bottom: 20;"><h1 class="basictext outlinetext">Download Arvopia 0.4.zip</h1></div></a>

                <div class="section" stlye="margin-bottom: 20; height: auto;"><h1 class="basictext outlinetext">Note:</h1><h2 class="basictext">When loading a world in 0.4, you will have to open the options menu (this has to be after opening a world, every time you open a world), make sure that FPS is set to 60, and light quality is pretty high (doesn't actually improve overall quality). Otherwise, the game will run very slowly.</h2></div>
                <div class="splitter" style="margin-bottom:10;"></div>
                <a href="arvopia0.3" style="position:relative; float:left; margin-bottom: 10;"><div style="margin-left: 10;"><h3 class="basictext">Previous Version: 0.3</h3></div></a>
                ...
                <a href="arvopia0.5" style="position:relative; float:right; margin-bottom: 10;"><div style="margin-right: 10;"><h3 class="basictext">Next Version: 0.5</h3></div></a>
