...
<body>
    <?php
        ...
        for($i = 0; $i < count($group["members"]); $i++) {
            echo "<a class='select-link' href='../person/{$group["members"][$i]}'><div class='select mcbg'>
        ...
        if(count($group["builds"])>0 && $group["builds"][0]!="") {
            ...
            for($i = 0; $i < count($group["builds"]); $i++) {
                echo "<a class='select-link' href='../build/{$data["builds"][$group["builds"][$i]]["page"]}'><div class='select mcbg'>
        ...
        if(count($group["events"]) > 0 && $group["events"][0]!="") {
            ...
            for($i = 0; $i < count($group["events"]); $i++) {
                echo "<a class='select-link' href='../event/{$data["events"][$group["events"][$i]]["page"]}'><div class='select mcbg'>
