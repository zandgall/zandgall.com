...
<h1 class="basictext outlinetext" style="margin: 100px auto 50px auto" id="qb64">What is the Library?</h1>
<div class="" style="position: relative; margin: 0 auto auto auto; width: 800;">
...
<h1 class="basictext outlinetext" style="margin: 100px auto 50px auto" id="qb64">How do I implement it?</h1>
<div class="" style="position: relative; margin: 0 auto auto auto; width: 800;">
...
<h1 class="basictext outlinetext" style="margin: 100px auto 50px auto" id="qb64">How do I use it?</h1>
<div class="" style="position: relative; margin: 0 auto auto auto; width: 800;">
...
<h1 class="basictext outlinetext" style="width: 800">Example code to show the basic usage of NBT c++ and GZNBT.</h1>
<img style = "position: relative; width: 800" src="assets/nbt example.png"></img>
<!-- </div> -->
