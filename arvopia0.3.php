    ...
    <div id = "cut" style="height: 100vh; width: 100%; top: 0; left: 0; overflow: hidden;">
        <div id="universal" class = "parallax">
            ...
            <div class="section" style="position: relative; margin-left: auto; margin-right: auto; margin-top: 80; width: 800">
                ...
                <!--STUFF HERE-->
                <img class="section"src="assets/arvopia/arvopia0.3.png" style="width:98%; position: relative; left:0.8%; margin-top:5">
                <h1 class="basictext">
                    Version 0.3
                </h1>
                ...
                <img class="section" src="assets/arvopia/arvopia 0.3/health bars.png" style="image-rendering: pixelated; width:98%; position: relative; left:0.8%">
                ...
                <a href="Downloads/Platformer0.3.zip"><div class="section" style="width:75%; margin-left: auto; margin-right: auto; margin-bottom: 20;"><h1 class="basictext outlinetext">Download Arvopia 0.3.zip</h1></div></a>
                <div class="splitter" style="margin-bottom:10;"></div>
                <a href="arvopia0.2" style="position:relative; float:left; margin-bottom: 10;"><div style="margin-left: 10;"><h3 class="basictext">Previous Version: 0.2</h3></div></a>
                ...
                <a href="arvopia0.4" style="position:relative; float:right; margin-bottom: 10;"><div style="margin-right: 10;"><h3 class="basictext">Next Version: 0.4</h3></div></a>
