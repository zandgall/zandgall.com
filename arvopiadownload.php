...
$pagedesc = "Download links for Arvopia versions 0.1-0.7";
include "global/head_.php"?>

<body>
    <?php 
    $title = "Download Arvopia!";
    $subtitle = "Don't worry, only some of them are horrendously broken!";
    include "global/head.php"?>
            ...
            <div class="section" style="position: relative; margin-left: auto; margin-right: auto; margin-top: 80; width: 800">
                ...
                <h1 class = "basictext">Additional Information about each version can be found <a href="ar.php">here</a></h1>
            </div>
