...
<div style="position: relative; margin-left: auto; margin-right: auto; margin-top: 0; width: min(800px, 80vw); margin-bottom: 2cm">
    ...
    <h1 class="basictext outlinetext" style="font-size:48pt; margin-bottom:-18pt">Arvopia Level Creator</h1>
    ...
    <img class="section" src="../assets/arvopia/LevelCreator0.1.png" style="width:120%; margin-left:-10%; position: relative; z-index: 2;" alt="Arvopia Level Creator 0.1 Screenshot">
    ...
    <a href="../Downloads/LevelCreator0.1.zip"><div class="section" style="width:75%; margin-left: auto; margin-right: auto; margin-bottom: 1cm;"><h1 class="basictext outlinetext">LevelCreator0.1.zip - 148KB [BROKEN]</h1></div></a>
    <div class="splitter"></div>

    <img class="section" src="../assets/arvopia/LevelCreator0.2.png" style="width:120%; margin-left:-10%; position: relative; z-index: 2;" alt="Arvopia Level Creator 0.2 Screenshot">
    ...
    <a href="../Downloads/LevelCreator0.2.zip"><div class="section" style="width:75%; margin: 0 auto 1cm auto;"><h1 class="basictext outlinetext">LevelCreator0.2.zip - 149KB</h1></div></a>
    <div class="splitter"></div>

    <img class="section" src="../assets/arvopia/LevelCreator0.3.png" style="width:120%; margin-left:-10%; position: relative; z-index: 2;" alt="Arvopia Level Creator 0.3 Screenshot">
    ...
    <a href="../Downloads/LevelCreator0.3.zip"><div class="section" style="width:75%; margin: 0 auto 1cm auto"><h1 class="basictext outlinetext">LevelCreator0.3.zip - 330KB</h1></div></a>
    <div class="splitter"></div>
    <img class="section" src="../assets/arvopia/LevelCreator0.4.png" style="width:120%; margin-left:-10%; position: relative; z-index: 2;" alt="Arvopia Level Creator 0.4">
    ...
    <a href="../Downloads/LevelCreator0.4.zip"><div class="section" style="width:75%; margin: 0 auto 1cm auto"><h1 class="basictext outlinetext">LevelCreator0.4.zip - 375KB</h1></div></a>
    <div class="splitter"></div>
    <a href="index"><div class="section" style="width:50%; margin: 1cm auto 1cm auto"><h1 class="basictext outlinetext">Home</h1></div></a>
</div>
