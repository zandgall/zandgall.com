...
<div class="section" style="position: relative; margin-left: auto; margin-right: auto; margin-top: 0; width: min(800px, 80vw); margin-bottom: 2cm">
    ...
    <img class="section" src="../assets/thumbnail/AnimatorThumb.png" style="width:120%; margin-left:-10%; position: relative; z-index: 2;" alt="Animator Thumb">
    ...
    <div class="splitter"></div>
    <img class="section" src="../assets/thumbnail/TradingThumb.png" style="width:120%; margin-left:-10%; position: relative; z-index: 2;" alt="Trading Thumb">
